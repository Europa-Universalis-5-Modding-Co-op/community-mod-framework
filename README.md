...
- **[GUI Macros](https://github.com/Europa-Universalis-5-Modding-Co-op/community-mod-framework/wiki/GUI-Macros)**: Extended GUI data binding macros (NAND, NOR, XOR logical operators).
