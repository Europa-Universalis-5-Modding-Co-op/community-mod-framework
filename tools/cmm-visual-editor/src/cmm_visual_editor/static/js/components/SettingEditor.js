const SettingEditorComponent = {
    ...
    computed: {
        ...
        settingFlags() {
            ...
            if (this.setting.setting_type === 'dropdown') {
                flags.push({ key: 'multiselector', label: 'Multi-Selector Layout', hint: '(Side-by-side buttons instead of a dropdown; best for up to 4 options)' });
            }
            return flags;
        },
        accessorLabel() {
